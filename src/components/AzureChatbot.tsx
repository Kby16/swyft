        ...
        <>
            ...
            {isOpen && (
                <div className="fixed bottom-20 right-4 w-96 h-[600px] bg-white rounded-lg shadow-xl flex flex-col z-50">
                    {/* Header */}
                    <div className="bg-[#111827] text-white p-4 rounded-t-lg flex justify-between items-center">
                        <div className="flex items-center">
                            <FaComments className="w-5 h-5 mr-2" />
                            <h3 className="font-semibold">Swft</h3>
                        </div>
                    ...
                    <div className="flex-1 overflow-y-auto p-4 space-y-4">
                            ...
                            >
                                <div
                                    className={`max-w-[80%] rounded-lg p-3 ${message.role === "user"
                                            ? "bg-[#10B981] text-white" // Teal user messages
                                            : "bg-[#F3F4F6] text-gray-800" // Light gray bot messages
                                        }`}
                                >
                        ...
                        {isLoading && (
                            <div className="flex justify-start">
                                <div className="bg-[#555555] rounded-lg p-3">
                                    <div className="flex items-center">
                                        <FaComments className="w-5 h-5 mr-2" />
                    ...
                    <form onSubmit={handleSubmit} className="p-4 border-t">
                        <div className="flex space-x-2">
                            ...
                            <button
                                ...
                                className="bg-[#10B981] text-white p-2 rounded-lg hover:bg-[#059669] disabled:opacity-50 disabled:cursor-not-allowed"
                            >
                                <FaPaperPlane />
                            </button>
                        </div>
