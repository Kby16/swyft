...
export default function BrazeSupportPage() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-black via-[#1E1B4B] to-[#312E81] text-[#D1D5DB] relative overflow-hidden">
      ...
      <section className="relative py-20 overflow-hidden bg-gradient-to-b from-black via-[#1E1B4B] to-[#312E81]">
        ...
        >
          ...
          <p className="text-xl text-center max-w-2xl mx-auto mb-12 text-[#D1D5DB]">
            Get help with the Braze platform and find resources to maximize your success
          </p>
        </motion.div>
      </section>
            ...
            {[
              {
                ...
                title: "Documentation",
                description: "Comprehensive guides and tutorials to help you get the most out of Braze",
                link: "Learn More"
              },
              {
                icon: "M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z",
                title: "Community Forum",
                description: "Connect with other Braze users and share best practices",
                link: "Join Discussion"
              },
              {
                icon: "M18.364 5.636l-3.536 3.536m0 5.656l3.536 3.536M9.172 9.172L5.636 5.636m3.536 9.192l-3.536 3.536M21 12a9 9 0 11-18 0 9 9 0 0118 0zm-5 0a4 4 0 11-8 0 4 4 0 018 0z",
                title: "Technical Support",
                description: "Get help from our technical support team for any issues",
              ...
              },
              {
                ...
                title: "Status Page",
                description: "Check the current status of Braze services and systems",
                link: "Check Status"
              }
            ].map((option, index) => (
              <motion.div
              ...
              >
                ...
                <h3 className="text-2xl font-bold mb-4 text-[#5ECDEF]">{option.title}</h3>
                <p className="text-[#D1D5DB] mb-6">{option.description}</p>
                <a
                  href="#"
                  className="inline-flex items-center text-[#5ECDEF] hover:text-[#5ECDEF]/80 transition-colors duration-300"
                >
                  {option.link}
      ...
      <section className="py-16 bg-gradient-to-b from-black via-[#1E1B4B] to-[#312E81]">
        <div className="container mx-auto px-4">
          ...
          >
            <h2 className="text-3xl font-bold mb-8 text-center text-[#5ECDEF]">Contact Support</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div>
                <h3 className="text-xl font-bold mb-4 text-[#5ECDEF]">Support Channels</h3>
                <ul className="space-y-3 text-[#D1D5DB]">
                  <li className="flex items-start">
                    ...
                    <span>Email: support@braze.com</span>
                  </li>
                  <li className="flex items-start">
                    <svg className="w-6 h-6 mr-2 text-[#5ECDEF] flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                    </svg>
                    <span>Phone: +1 (888) 123-4567</span>
                  </li>
                  <li className="flex items-start">
                    <svg className="w-6 h-6 mr-2 text-[#5ECDEF] flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div>
                <h3 className="text-xl font-bold mb-4 text-[#5ECDEF]">Support Hours</h3>
                <ul className="space-y-3 text-[#D1D5DB]">
                  <li className="flex items-start">
                    <svg className="w-6 h-6 mr-2 text-[#5ECDEF] flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                    </svg>
                    <span>Standard: Mon-Fri, 9AM-5PM EST</span>
                  </li>
                  <li className="flex items-start">
                    <svg className="w-6 h-6 mr-2 text-[#5ECDEF] flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                  ...
                  <li className="flex items-start">
                    ...
                    <span>Emergency: 24/7 Critical Support</span>
                  </li>
                </ul>
              </div>
            </div>
