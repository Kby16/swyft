      ...
      <section className="relative py-20 overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative">
          ...
          <p className="text-xl text-center max-w-2xl mx-auto mb-12">
            Let&apos;s discuss how we can help you transform your customer experience with Braze
          </p>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          <div className="bg-white/5 backdrop-blur-sm rounded-xl p-8 shadow-lg border border-gray-800">
            ...
            <div className="aspect-w-16 aspect-h-9 rounded-lg overflow-hidden">
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3153.835434509374!2d-122.4194!3d37.7749!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x8085809c6c8f445b%3A0xb10ed6d9b5050fa3!2sSan%20Francisco%2C%20CA!5e0!3m2!1sen!2sus!4v1647041234567!5m2!1sen!2sus"
                width="100%"
                height="450"
                style={{ border: 0 }}
                allowFullScreen
